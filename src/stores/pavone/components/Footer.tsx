...
import { BRAND_NAME, WHATSAPP_NUMBER, buildWhatsAppUrl } from "@/stores/pavone/lib/whatsapp";
      ...
      <div className="container-page py-16 grid gap-12 md:grid-cols-4">
        <div className="md:col-span-2 max-w-sm">
          ...
          <div className="mt-6 flex items-center gap-3">
            <a href={buildWhatsAppUrl("Hello Pavone, I have a question.")} target="_blank" rel="noreferrer"
              className="p-2.5 rounded-full bg-background hover:bg-blush transition-colors shadow-card" aria-label="WhatsApp">
